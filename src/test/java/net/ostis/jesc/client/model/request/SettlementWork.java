...
class SettlementWork {
    ...
    static class IsomorphicSubgraphSearchAgent extends ScAgent {
        ...
        public void onTrigger(ScEvent event) {
            ...
            log.info("Target node set: {}", targetNodeSet);
            log.info("Pattern node set: {}", patternNodeSet);
            log.info("Isomorphisms: {}", isomorphisms);
        }
